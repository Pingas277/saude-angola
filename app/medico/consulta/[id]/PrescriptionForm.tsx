  ...
  return (
    <form ref={formRef} action={formAction} className="space-y-4">
      ...
      <button
        ...
        className="inline-flex items-center gap-1 rounded-md border border-dashed border-border bg-card px-3 py-2 text-sm font-medium text-foreground hover:border-primary/40 hover:bg-primary/10/40"
      >
