#!/usr/bin/env node
// Promotes an existing user to role='nurse' and assigns them to the demo clinic.
// Usage:  node scripts/promote-to-nurse.js <email>
...
if (!email) {
  console.error('Usage: node scripts/promote-to-nurse.js <email>');
  process.exit(1);
}
...
console.log(`✓ Promoted ${email} to nurse at "${clinics[0].name}".`);
await client.end();
